	...
	<div class="super_container">
		...
		<div class="home">
			...
			<div class="home_content">
				<h1>¿Dudas? Preguntanos con confianza</h1>
			</div>
		</div>
						...
						<div class="contact_form_container">
							...
							<form action="/register" method="get">
								<input id="contact_form_name"
									class="input_field contact_form_name" type="text" name="nombre"
									placeholder="nombre" data-error="Escriba su nombre."> <input
									id="contact_form_name" class="input_field contact_form_name"
									type="text" name="apellido" placeholder="apellido"
									data-error= "Escriba suapellido."> <input
									id="contact_form_name" class="input_field contact_form_name"
									type="text" name="dni" placeholder="dni"
									data-error="Escriba su dni"> <input
									id="contact_form_name" class="input_field contact_form_name"
									type="text" name="email" placeholder="Gmail"
									data-error= "Escriba suemail"> <input
									id="contact_form_name" class="input_field contact_form_name"
									type="text" name="direccion" placeholder="Direccion"
									data-error="Escriba su direccion">
								<!-- <input type="email" name="email" required="required">
								<input type="text" name="apellido" pattern="[a-zA-Z ]+" required="required">
								<input id="contact_form_name" class="input_field contact_form_name" type="text" placeholder="Nombre" required="required" data-error="Escriba su nombre.">
								<input id="contact_form_email" class="input_field contact_form_email" type="email" placeholder="E-mail" required="required" data-error="Correo requerido.">
								<textarea id="contact_form_message" class="text_field contact_form_message" name="message" placeholder="Mensaje" required="required" data-error="Por favor, envia un Mensaje."></textarea>
								 -->
								<button id="contact_send_btn" type="submit"
									class="contact_send_btn trans_200" value="Submit">Registrar</button>
							</form>
