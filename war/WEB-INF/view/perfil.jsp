...
<link rel="stylesheet" type="text/css" href="styles/perfil_styles.css">
<link rel="stylesheet" type="text/css"
		...
		<header class="header d-flex flex-row">
			...
			<div
				...
				<%
					if (user != null) {
				%>
				<a href="/perfil"><span>Perfil</span></a> <a href="/logout"><span>Cerrar
						Sesion</span></a>
				<%
					} else {
				%>
						...
						<div class="contact_form_container" style="width: 100%">
							<form action="post">
								<div style="height: 50%; width: 50%; float: right;">
									<img src="images/hombre.jpg" height="100%" width="100%"
										alt="no disponible">
								...
								<h4>Nombre</h4>
								<input
									style="width: 30%; background: #f8f4f4; border: solid 2px transparent; margin-bottom: 24px; height: 42px; padding-left: 33px"
									value="<%=user.getName()%>" disabled="false" id="name"
									class="inputname" type="text" placeholder="Nombre"
									required="required" data-error="Escriba su nombre."><br>
								<h4>Correo Electronico</h4>
								<input id="email" style="width: 40%" name="email"
									value="<%=user.getEmail()%>" disabled type="email"
									placeholder="E-mail" required="required"
									data-error="Correo requerido." class="input_field contact_form_email">
								<h4>Fecha de ingreso</h4>
								<input style="width: 40%" value="<%=created%>" disabled
									id="ingreso" class="input_field contact_form_email"
									type="email" placeholder="E-mail" required="required"
									data-error="Correo requerido.">
								<h4>Fecha de nacimiento</h4>

								<input value="<%=birth%>" disabled style="width: 36%"
									type="date" id="birtho" class="input_field contact_form_email"
									placeholder="E-mail" required="required"
									data-error="fecha de nacimiento requrida" class="form-control"
									name="birth" placeholder="Birth" max="2050-05-24">
								<h4>Paquete Contratado</h4>
								<select id="paquete" disabled="true" style="width: 30%"
									...
									class="contact_send_btn trans_200" name="enviar" id="guardar"
									value="Guardar Cambios" style="width: 60%; display: none">
								<button href="/perfil?action=#"
									style="display: none; width: 20%; margin-left: 20px" id="btn"
									type="button" class="contact_send_btn trans_200" value="Submit">Cancelar</button>
								<button onclick="editar()" style="margin-bottom: 10px"
								...
								%>
								<a href="/admin?id=<%=user.getId()%>" disabled
									style="margin-left: 10px; margin-bottom: 10px; width: 30%"
									id="contact_send_btn" type="button"
									class="contact_send_btn trans_200" value="Submit">Administrar
									Usuarios </a>
								<%
									}
								%>
