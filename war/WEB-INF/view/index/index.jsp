						...
						<div
							...
							<div class="hero_slide_content text-center">
								<h1 data-animation-in="fadeInUp"
									...
									Obten tu <span>Conexion</span> Ahora!
								</h1>
							</div>
						</div>
					</div>
						...
						<div
							...
							<div class="register_content text-center">
								<h1 class="register_title">
									Contrata el servicio hoy mismo y obten <span>un
										descuento especial </span> en tus 2 primeros meses
								</h1>
								<div class="button button_1 register_button mx-auto trans_200">
									<a href="#">ir a PROMOCIONES</a>
								</div>
							</div>
						</div>
							...
							<div class="search_content text-center">
								...
								<input id="search_form_degree" class="input_field search_form_degree" type="text" placeholder="Degree"> -->
									<button id="search_submit_button" type="submit"
										class="search_submit_button trans_200" value="Submit">Buscar
										Servicios</button>
								</form>
							</div>
						</div>
