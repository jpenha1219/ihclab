	...
	<div class="super_container">
		...
		<header class="header d-flex flex-row">
			...
			<div
				...
				<a href="/register"><span>INGRESAR</span></a>
			</div>
						...
						<div class="news_posts">
							...
							<div class="news_post">
								...
								<div class="news_post_text">
									<p>Nosotros nacimos para brindarte un servicio mas completo
										y a un costo mas bajo que la competencia .....</p>
								</div>
						...
						<div class="sidebar">
							...
							<div class="sidebar_section">
								...
								<ul class="sidebar_list">
									<li class="sidebar_list_item"><a href="#">¿Que
											buscamos?</a></li>
									<li class="sidebar_list_item"><a href="#">¿Donde los
											ubico?</a></li>
									<li class="sidebar_list_item"><a href="#">¿En que
											lugares del Peru estan?</a></li>
