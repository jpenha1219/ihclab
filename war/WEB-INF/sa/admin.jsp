	...
	<div class="contact" style="width: 100%; padding: 40px; margin-top: 10%">
			<div class="row">
				<div class="col-lg-89" style="width: 100%">
					...
					<div class="contact_form">
						...
						<div class="contact_form_container" style="width: 100%">
							<form action="post">
								<div style="height: 50%;  width: 25% ;float: right;">
				...
				document.getElementById("contact_send_btn").style.display="none";
							...
							<table style="  border-color:#ffa;  ;margin-bottom: 30px; margin-left: 10px; width: 70%" border="3px">
								
								<tr  style="margin-left:10px; background-color:#ffb606; color: #ffff ">
									<th ><h3>Nombre</h3>	</th>
								...
								<tr  style="margin:10px; color: #000  ">
									...
									<td><label <%if(users.get(0).isStatus()==true){ %>checked<%} %> style="align-items: center; margin-left: 20px">
								<input checked type="checkbox" id="cbox1" value="on"> </label>	
								</td>
								</tr>
								<%} %>
							</table>			
<br>
								...
								<button href="/perfil?id=<%=user.getId() %>" style="margin-bottom:10px" id="contact_send_btn" type="button" class="contact_send_btn trans_200" value="Submit">Editar</button>
				<br>
							</form>
