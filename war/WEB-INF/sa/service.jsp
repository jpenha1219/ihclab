				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Plan  <span>X</span></div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Plan  <span>Y</span></div>
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>$$$</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Plan  <span>Z</span></div>
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>$$$</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Plan  <span>1</span></div>
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>$$$</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Plan   <span>2</span></div>
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>$$$</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Plan  <span>3</span></div>
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>$$$</span></div>
						</div>
					</div>
				</div>
